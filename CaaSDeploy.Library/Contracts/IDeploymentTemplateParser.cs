...
namespace DD.CBU.CaasDeploy.Library.Contracts
{
    ...
    /// </summary>
    public interface IDeploymentTemplateParser
    {
        /// <summary>
        ...
        TaskExecutor GetDeploymentTasks(CaasAccountDetails accountDetails, string templateFilePath, string parametersFilePath);
        ...
        /// <returns>Instance of <see cref="TaskExecutor"/> with tasks and task execution context.</returns>
        TaskExecutor GetDeletionTasks(CaasAccountDetails accountDetails, string deploymentLogFilePath);
    }
}